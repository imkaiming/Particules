...
{
    EnvelopeMenuControl::EnvelopeMenuControl(ValueTreeState& apvts, const str& mId, const str& rId, const str& jId)
        : MenuSliderBase(apvts, mId, rId, jId, "Envelope", "envelope")
    {
    }

    juce::Image EnvelopeMenuControl::createMenuIcon(int itemIndex)
    {
        const int w = 200;
        const int h = 40;
