#include "TraversalMenuControl.h"
#include "../../../utils/math/TraversalMath.h"

namespace particules
{
    TraversalMenuControl::TraversalMenuControl(ValueTreeState& apvts, const str& mId, const str& fId, const str& jId)
        : MenuSliderBase(apvts, mId, fId, jId, "Traversal", "traversal")
    {
    }

    juce::Image TraversalMenuControl::createMenuIcon(int itemIndex)
    {
        const int w = 200;
        const int h = 40;
